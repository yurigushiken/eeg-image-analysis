...
KEY_CONDITIONS_MAP = {
    "Landing on 1 (from 2,3)": ["21", "31"],
    "Landing on 2 (from 1,3)": ["12", "32"],
    "Landing on 3 (from 1,2)": ["13", "23"],
}
...
def generate_p1_plots(subjects_to_process):
    ...
    for subject_id in subjects_to_process:
        ...
        try:
            ...
            fig.suptitle(f'Subject {subject_id}: P1 Analysis (Within Small Numbers, ACC=1)', fontsize=16)
            ...
            fig_path = os.path.join(subject_figure_dir, f'sub-{subject_id}_p1_plot_within_small_acc=1.png')
    ...
    fig_grp.suptitle('Grand Average: P1 Analysis (Within Small Numbers, ACC=1)', fontsize=16)
    ...
    fig_path_grp = os.path.join(group_figure_dir, 'group_p1_plot_within_small_acc=1.png')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate EEG P1 waveform and topomap plots.')
