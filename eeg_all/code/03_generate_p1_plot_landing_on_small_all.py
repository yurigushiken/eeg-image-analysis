...
def generate_p1_plots(subjects_to_process):
    ...
    for subject_id in subjects_to_process:
        ...
        try:
            ...
            fig.suptitle(f'Subject {subject_id}: P1 Analysis (Landing on Small, ALL)', fontsize=16)
            ...
            fig_path = os.path.join(subject_figure_dir, f'sub-{subject_id}_p1_plot_landing_on_small_all.png')
    ...
    fig_grp.suptitle('Grand Average: P1 Analysis (Landing on Small, ALL)', fontsize=16)
    ...
    fig_path_grp = os.path.join(group_figure_dir, 'group_p1_plot_landing_on_small_all.png')
