...
def generate_p1_pair_plots():
    ...
    for inc_cond, dec_cond in NUMBER_PAIRS:
        print(f"\n--- Generating P1 group plot for {inc_cond} vs {dec_cond} (ALL) ---")
        ...
        script_name = f"03_generate_p1_numbers_pair_plot_inc{inc_cond}_vs_dec{dec_cond}_all"
        ...
        fig_grp.suptitle(f'Grand Average: P1 ({inc_pair_str} vs {dec_pair_str}, ALL)', fontsize=16)
