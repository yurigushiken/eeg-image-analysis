...
BASE_CONDITIONS = ["iLL", "dLL", "NoChg"]

# How to combine base conditions into key conditions
KEY_CONDITIONS_MAP = {
    "Increasing-Large": ["iLL"],
    "Decreasing-Large": ["dLL"],
    "No-Change": ["NoChg"],
}

# Define colors for plots
CONDITION_COLORS = {"Increasing-Large": "blue", "Decreasing-Large": "red", "No-Change": "grey"}
...
def generate_n1_plots(subjects_to_process):
    ...
    for subject_id in subjects_to_process:
        ...
        try:
            ...
            fig.suptitle(f'Subject {subject_id}: N1 Analysis (Within Large)', fontsize=16)
            ...
            fig_path = os.path.join(subject_figure_dir, f'sub-{subject_id}_n1_plot_within_large.png')
    ...
    fig_grp.suptitle('Grand Average: N1 Analysis (Within Large)', fontsize=16)
    ...
    fig_path_grp = os.path.join(group_figure_dir, 'group_n1_plot_within_large.png')
